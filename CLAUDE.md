...
- **No i18n** - deferred. Tests: Vitest covers the pure `src/lib` helpers (`*.test.ts` co-located); UI/Rust are untested. See `docs/ROADMAP.md`. (Comment persistence is done - SQLite.)
